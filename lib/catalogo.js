...
// Los cinco tintes son exactamente los stops del degradado --sun-1…--sun-5 de globals.css.
// Viven acá y no en lib/precios.js porque el editor es un componente cliente: importarlos
// desde precios.js arrastraría lib/almacen.js, que usa node:fs, al bundle del navegador.
export const TINTES = ['#6D2B6B', '#B03A46', '#DC4A1E', '#F08A2A', '#FFBE3D'];
...
/**
 * Los comandos del juego, tal como se escriben.
 *
 * `pasos` es opcional: los que se hacen de un tirón no lo llevan, y los que tienen su
 * procedimiento —la grúa— lo muestran numerado. Un comando que hay que hacer en cinco pasos
 * no cabe en una línea de descripción, y era eso o que la gente siguiera preguntando.
 */
export const COMANDOS = [
  ...
  {
    comando: '/tow',
    descripcion: 'Enganchar un vehículo a la grúa',
    pasos: [
      'Súbete a la grúa y también al vehículo dañado: hay que haber entrado a los dos.',
      'Deja los dos vehículos lo más pegados posible, uno junto al otro.',
      'Escribe el comando: aparece un puntero en pantalla.',
      'Selecciona primero la grúa y después el vehículo que vas a remolcar.',
      'Confirma con E y el vehículo queda enganchado.',
    ],
  },
  {
    comando: '/untown',
    descripcion: 'Desenganchar el vehículo de la grúa',
    pasos: ['Escribe el comando y selecciona el vehículo.', 'Suéltalo con E.'],
  },
];
