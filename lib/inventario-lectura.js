...
/**
 * La deducción del lector, **solo si de verdad completa** el nombre cortado.
 *
 * Tiene que empezar exactamente igual y añadir algo: así el nombre completo que se guarde sigue
 * casando por prefijo con la captura cortada de mañana, y no aparece un duplicado.
 */
export function completar(literal, sugerencia) {
  ...
  return !larga.truncado && larga.base.startsWith(corto.base) && larga.base !== corto.base
    ? propuesta
    : '';
}
