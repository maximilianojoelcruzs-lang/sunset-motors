...
//
//   { id, usuario, monto, descripcion, imagen, estado, respuesta, resuelto, resueltoPor,
//     creado, enviado }
//
...
// un borrador sin ella, pero no mandarlo.
...
export async function enviar(id, usuario) {
  ...
  if (!lista[i].imagen) return { error: 'Para enviarla hace falta la captura del monto.' };
