...
/**
 * Cuántas minas se pueden poner.
 *
 * **Cuantas más minas, más rápido sube el multiplicador** — y no es un ajuste que se pueda
 * tocar: el pago sale de la probabilidad de seguir vivo, así que con 10 minas la escalera va
 * x1,62 · x2,77 · x4,90 · x8,99 · x17,16 y se dispara en cinco casillas. Con 24 la partida
 * dura un solo toque.
 *
 * Se quedaron 1, 3 y 5, que es donde la escalera sube de a poco y la partida se siente una
 * partida. Volver a poner 10 o 24 devuelve el mismo salto — la forma de que suba más despacio
 * es menos minas, no otra tabla de pagos.
 */
export const MINAS = [1, 3, 5];
